...
export default function Footer() {
  return (
    <div className='bg-[#F1F1F1] dark:bg-gray-900'>
      <div className='mx-auto  max-w-6xl py-10 px-4 md:py-20'>
        ...
        <div className='mt-8 flex flex-col justify-between space-y-4 md:flex-row md:items-center md:space-y-0'>
          ...
          <div>
            ...
            <p>
              Developed by
              <div className='inline-block transition duration-300 hover:-rotate-3 hover:scale-110'>
                <a
                  className='rounded-md py-1 px-2 hover:bg-red-500  hover:text-gray-50'
